      ...
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="bg-white p-8 rounded-lg shadow-md border">
            ...
            <div class="mt-6 flex space-x-4">
              <!-- Edit Button -->
              <a href="{{ route('admin.project.edit', $project->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded-lg hover:bg-yellow-600 transition duration-200">
                Edit
              </a>
              
              <!-- Delete Button (with confirmation modal) -->
              <form action="{{ route('admin.project.delete', $project->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this project?');">
                @csrf
                @method('DELETE')
            ...
            <!-- Back Button -->
            <div class="mt-6">
              <a href="{{ route('admin.project.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition duration-200">
                Back to Projects
              </a>
            </div>
          </div>
