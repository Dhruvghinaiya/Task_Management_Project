...
<div class="min-h-full">
  ...
  <div class="mt-8 flex justify-end items-center space-x-4">
                <a href="{{ route('client.task.index') }}" class="px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition duration-300 ease-in-out text-center w-full sm:w-auto">
                    Back to Task List
                </a>
