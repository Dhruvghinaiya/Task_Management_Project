...
<div class="min-h-full">
  ...
  <div class="mt-8 flex justify-end items-center space-x-4">
        <a href="{{ route('employee.task.edit', $task->id) }}" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300 ease-in-out text-center w-full sm:w-auto">
            Edit Task
        </a>

                <a href="{{ route('employee.task.index') }}" class="px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition duration-300 ease-in-out text-center w-full sm:w-auto">
                    Back to Task List
                </a>
